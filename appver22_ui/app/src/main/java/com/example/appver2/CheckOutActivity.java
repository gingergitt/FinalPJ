    ...
    public class CardTask extends AsyncTask<String, Void, String> {
     public String id;
        ...
        public void setURL(String cardno, String cardname, String id , String cardagency) {
            ...
            urlstr2 = "http://192.168.0.6/oracledb/androidCard.jsp?cardno="+cardno+"&cardname="+cardname
                    +"&id="+id+"&cardagency="+cardagency;

//
//            urlstr2 = "http://192.168.0.25:8088/finalpj/androidCard.jsp?cardno="+cardno+"&cardname="+cardname
//                    +"&id="+id+"&cardagency="+cardagency;
            Log.d("----------------","usl연결확인되었습니다.");
        }
