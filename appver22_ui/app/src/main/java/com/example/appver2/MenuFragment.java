...
//            urlstr = "http://192.168.1.162/oracledb/androidLogin.jsp?id="+id+"&pwd="+pwd;
            ...
            urlstr2 = "http://192.168.0.25:8088/finalpj/androidLogin.jsp?id="+id+"&cardname="+cardname+"&cardagency="+cardagency;
...
//            urlstr3 = "http://192.168.0.25:8088/finalpj/androidCardPlus.jsp?id="+id;
            Log.d("----------------","usl연결 oK?");
        }
...
//                        //main으로 옮겨진 상태?
                        ...
                        while (a < MAX_ITEM_COUNT) {
                            if (a == 1) {
                                data.add(new VerticalData(R.drawable.ic_card_bg, a+ "번째 카드"));
                            } else if (a == 2) {
...
//            urlstr4 = "http://192.168.0.25:8088/finalpj/androidPayHistory.jsp?id="+id;
